...
var resizePizzas = function(size) { 
	...
	function changePizzaSizes(size) {
		...
		var pizzasLength = document.querySelectorAll(".randomPizzaContainer").length; 
...
function updatePositions() {
	...
	var cachedScrollTop=document.body.scrollTop; // calling document.body.scrollTop is unnecesary on every iteration
